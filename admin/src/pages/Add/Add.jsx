    ...
    <div className='add'>
      <form className='flex-col' onSubmit={onsubmithandler}>
        ...
        <div className="add-product-name flex-col">
          <p>Product Name</p>
          <input onChange={onchagehandler} value={data.name} type='text' name='name' placeholder='Type here' />
        </div>
        ...
        <div className="add-category-price">
          ...
          <div className="add-price flex-col">
            <p>product Price</p>
            <input onChange={onchagehandler} value={data.price} type='number' name='price' placeholder='$20' />
          </div>
        </div>
